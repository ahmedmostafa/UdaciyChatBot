...
ChatBot::ChatBot()
{
    std::cout << "ChatBot Constructor no init at address " << this << std::endl;
...
{
    std::cout << "ChatBot Constructor with init at address " << this << std::endl;
...
ChatBot::~ChatBot()
{
    std::cout << "ChatBot Destructor at address " << this << std::endl;
...
{
    std::cout << "ChatBot, Start of Copy Constructor" << std::endl;
    _image = new wxBitmap();
    *_image = *(src._image);
...
{
    std::cout << "ChatBot: Start of Copy Assignment" << std::endl;
    if (this == &src)
        return *this;
...
{
    std::cout << "ChatBot, Start of Move Constructor" << std::endl;
...
{
    std::cout << "ChatBot: Start of Move Assignment" << std::endl;
    if (this == &src)
        return *this;
