...
public:
    ...
    // getter / setter 
    //T.1 adapt the return of the function to return the raw pointer. 
    // cant return the unique_ptr by value, and in case moving, it means transfering the ownership ( as far as I understand :D)
