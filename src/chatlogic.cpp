...
ChatLogic::~ChatLogic()
{
   ...
   /////////// delete _chatBot;
    ...
    // delete all nodes /**** T.3 *****/
    //  for (auto it = std::begin(_nodes); it != std::end(_nodes); ++it)
    //{
    //    delete *it;
    //}

    // delete all edges /**** T.4 *****/
            ...
            if (type != tokens.end())
            {
                ...
                if (idToken != tokens.end())
                {
                    ...
                    if (type->second == "NODE")
                    {
                        ...
                        {
                            _nodes.emplace_back(std::make_unique<GraphNode>(id)); /****** T.3 ********/
                    ...
                    if (type->second == "EDGE")
                    {
                        ...
                        if (parentToken != tokens.end() && childToken != tokens.end())
                        {
                            ...
                            // create new edge
                            std::unique_ptr<GraphEdge> edge = std::make_unique<GraphEdge>(id);     /**** T.4 *****/
                            edge->SetChildNode((*childNode).get()); /****** T.3 ********/
                            edge->SetParentNode((*parentNode).get());   /****** T.3 ********/
                                /**** T.4 *****/
                            ...
                            (*childNode)->AddEdgeToParentNode(edge.get()); /**** T.4 *****/
                            (*parentNode)->AddEdgeToChildNode(std::move(edge)); /**** T.4 *****/
                        }
